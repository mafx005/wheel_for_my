...
if __name__ == '__main__':
    num_aug = 3  # 每条原始语句增强的语句数
    alpha = 0.2  # 每条语句中将会被改变的单词数占比
    input_filename = '../data_out/znfz_fact_qisuyijianshu.txt'
    output_filename = '../data_out/znfz_fact_qisuyijianshu_augment.txt'
    gen_eda(input_filename, output_filename, alpha=alpha, num_aug=num_aug)
